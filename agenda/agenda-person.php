...
<section class="content-header">
	<h1>Agendamiento
		<small><i class="fa fa-angle-right"></i> Agendas Registradas por Persona</small>
	</h1>

	<ol class="breadcrumb">
		<li><a href="index.php?section=home"><i class="fa fa-home"></i>Inicio</a></li>
		<li class="active">Agendas Registradas por Persona</li>
	</ol>
</section>
...
<section class="content container-fluid">
			...
			<div class="box-body">
				...
				<div class="row">
					<div class="form-group col-xs-4 has-feedback" id="gperiodo">
						...
						<select class="form-control" id="iNperiodo" name="iperiodo">
							<option value="">ÚLTIMA INGRESADA</option>
	...
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title" id="table-title-f">Personas con agendas registradas</h3>
		</div>
...
<script src="agenda/agenda-person.js"></script>