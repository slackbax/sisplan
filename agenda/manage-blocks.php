...
<section class="content-header">
	<h1>Agendamiento
		<small><i class="fa fa-angle-right"></i> Ausencias Registradas</small>
	</h1>

	<ol class="breadcrumb">
		<li><a href="index.php?section=home"><i class="fa fa-home"></i>Inicio</a></li>
		<li class="active">Ausencias Registradas</li>
	</ol>
</section>
...
<section class="content container-fluid">
				...
				<div class="row">
					<div class="form-group col-xs-4 has-feedback" id="gcr">
						...
						<select class="form-control" id="iNcr" name="icr">
							<option value="">TODOS LOS CENTROS DE RESPONSABILIDAD</option>
							<?php $cen = $cr->getAll() ?>
	...
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title" id="table-title-f">Ausencias registradas</h3>
		</div>
...
<script src="agenda/manage-blocks.js"></script>