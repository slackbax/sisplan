...
foreach ($agen as $a => $v):
	if ($v->act_cxc)
		$agendado += $v->age_cupos;
	else
		$agendadoOtros += $v->age_cupos;
endforeach;
?>
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="index.php?section=agenda&sbs=createagenda">Personas disponibles para agendar</a></li>
							...
							<div class="box-footer">
								<div class="row">
									...
									<div class="col-md-6 text-right">
										...
										<button type="button" class="btn btn-lg btn-primary" id="btnsubmit"><i class="fa fa-check"></i> Guardar Agenda</button>
									</div>
								</div>
							</div>
						</div>
...
<script src="agenda/create-agenda.js"></script>
<script src="agenda/create-agenda-block.js"></script>