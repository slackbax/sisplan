...
module.exports = function (grunt) { // jshint ignore:line
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both SISPlan.css and SISPlan.min.css
    less  : {
      // Development not compressed
      development  : {
        files: {
          // compilation.css  :  source.less
          'dist/css/AdminLTE.css'                     : 'build/less/SISGDoc.less',
      ...
      production   : {
        ...
        files  : {
          // compilation.css  :  source.less
          'dist/css/AdminLTE.min.css'                     : 'build/less/SISGDoc.less',
          // AdminLTE without plugins
    ...
    uglify: {
      ...
      production: {
        files: {
          'dist/js/adminlte.min.js': ['dist/js/sisplan.js']
        }
      }
    },
